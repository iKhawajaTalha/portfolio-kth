...
export default function Services() {
  ...
  return (
    <section id="services" className="relative overflow-hidden">
      <div className="absolute top-0 right-0 w-80 h-80 bg-accent/[0.02] rounded-full blur-[100px]" />
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {items.map((service, i) => (
            <motion.div
              ...
              className="relative bg-dark-card border border-dark-lighter rounded-xl p-7 group hover:border-accent/30 transition-all duration-300 hover:shadow-xl hover:shadow-accent/5 overflow-hidden"
            >
              {/* Top accent line */}
